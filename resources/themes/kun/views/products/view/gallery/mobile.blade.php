<!-- Mobile Gallery — swipeable carousel with rounded images -->
<div
    class="overflow-hidden 1180:hidden"
    v-if="isMediaLoading"
>
    <div class="shimmer aspect-square max-h-screen w-screen rounded-b-[17px] bg-slate-200"></div>
</div>

<div
    class="scrollbar-hide flex w-screen gap-5 overflow-auto max-sm:gap-3 1180:hidden"
    v-else
>
    <v-product-carousel
        :options="[
...
@pushOnce('scripts')
    ...
    >
        <div class="relative m-auto flex w-full overflow-hidden">
            ...
            <!-- Pagination Dots -->
            <div
                class="absolute bottom-4 left-0 flex w-full justify-center gap-1.5 max-sm:bottom-3"
                role="tablist"
            ...
            >
                <div
                    ...
                    :class="{ 'bg-[#b95b27] w-4': index === Math.abs(currentIndex), 'bg-slate-300': index !== Math.abs(currentIndex) }"
                    role="tab"
                    :aria-selected="index === Math.abs(currentIndex)"
