...
return [
    ...
    'modules' => [
         ...
         * Kun packages.
         */
        \Kun\PaymentGateway\Providers\ModuleServiceProvider::class,
        \Kun\Shipping\Providers\ModuleServiceProvider::class,
        \Kun\SmartLinks\Providers\ModuleServiceProvider::class,
        \Kun\CodVerification\Providers\ModuleServiceProvider::class,
        \Kun\CountryPage\Providers\ModuleServiceProvider::class,
        \Kun\Search\Providers\ModuleServiceProvider::class,
        \Kun\Analytics\Providers\ModuleServiceProvider::class,
        \Kun\SellerStory\Providers\ModuleServiceProvider::class,
        \Kun\CulturalCraft\Providers\ModuleServiceProvider::class,
        \Kun\ImageOptimizer\Providers\ModuleServiceProvider::class,
    ],
